...
def find_invalid_records(
    ...
    constraints = {
        ...
        'gender' : isinstance(gender, string) and gender.lower() in ('male', 'female'),
        'diagnosis' : isinstance(diagnosis, str) or diagnosis is None,
        'medication' : isinstance(medications, list),
        'last_visited_id' : isinstance(last_visit_id, str) and re.fullmatch('v\d+' , last_visit_id, re.IGNORECASE)
